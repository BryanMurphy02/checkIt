...
class InteractionsScreenWidget extends StatefulWidget {
  const InteractionsScreenWidget({Key? key}) : super(key: key);

  @override
  _InteractionsScreenWidgetState createState() =>
      _InteractionsScreenWidgetState();
}
